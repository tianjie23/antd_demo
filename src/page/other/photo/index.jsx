...
const bread = [
    ...
    {href: "", title: "其他", icon: ""},
    {href: "/other/photo", title: "画廊", icon: ""},
];
                    ...
                    <div className="pswp__scroll-wrap">
                        ...
                        <div className="pswp__ui pswp__ui--hidden">
                            ...
                            <div className="pswp__top-bar">
                                ...
                                <button className="pswp__button pswp__button--close" title="关闭 (Esc)" />

                                <button className="pswp__button pswp__button--share" title="分享" />

                                <button className="pswp__button pswp__button--fs" title="切换全屏" />
                            ...
                            <button className="pswp__button pswp__button--arrow--left" title="上一个 (arrow left)" />

                            <button className="pswp__button pswp__button--arrow--right" title="下一个 (arrow right)" />
